...
RSpec.describe "/configs", type: :request do
  ...
  # ConfigsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get configs_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Config" do
        expect {
          post configs_url,
               params: { config: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Config" do
        expect {
          post configs_url,
               params: { config: invalid_attributes }, as: :json
        }.to change(Config, :count).by(0)
      end

      it "renders a JSON response with errors for the new config" do
        post configs_url,
             params: { config: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested config" do
        ...
        patch config_url(config),
              params: { config: new_attributes }, headers: valid_headers, as: :json
        config.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested config" do
      config = Config.create! valid_attributes
      expect {
        delete config_url(config), headers: valid_headers, as: :json
      }.to change(Config, :count).by(-1)
    end
  end
end
